...
namespace implemented
{
    class Camera1
    {
     public:
        ...
        {
            // Translates the Camera1 using the `dir` vector computed from
            // `forward`. Movement will always keep the Camera1 at the same
        ...
        {
            // TODO(student): Translate the Camera1 using the `forward` vector.
        ...
        {
            // TODO(student): Translate the Camera1 using the `up` vector.
        ...
        void TranslateRight(float distance)
        {
            ...
            // You need to translate the Camera1 using the `right` vector.
            // Usually, however, translation using Camera1's `right` vector
            // is not very useful, because if the Camera1 is rotated around the
            // `forward` vector, then the translation on the `right` direction
            // will have an undesired effect, more precisely, the Camera1 will
